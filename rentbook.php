    ...
    <section>
      <div class="jumbotron jumbotron-fluid">
        <div class="container" id="jumbo">
          <h1 class="display-4">Rent Out Books</h1>
          <p class="lead">Upload your book to rent out. Make sure to enter proper duration, and the total fees for that duration.</p>
        </div>
      </div>
    </section>
      ...
      <div class = "container">
        ...
        <div class = "form-group">
          ...
          <div class = "form-group">
            ...
            <div class = "form-group">
              <div class = "col-sm-6">
                <label class="form-check-label" for="fname">Duration</label><br>
...
if ($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  $sql = "INSERT INTO entrybook (`uploaded_by`,`bookid`, `book_name`, `book_image`, `author`, `rent`, `category`, `price`, `description`) VALUES ('{$_SESSION['USERNAME']}','$bid','$bookname','".$fileName."','$auth', '$rent', '$categ','$price','$desc')";
  ...
  $query2 = "INSERT INTO rent (`bookid`, `duration`) VALUES('$bid','$duration')";  
